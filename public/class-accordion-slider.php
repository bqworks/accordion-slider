...
class BQW_Accordion_Slider {
	...
	public function register_styles() {
		if ( get_option( 'accordion_slider_load_unminified_scripts' ) == true ) {
			wp_register_style( $this->plugin_slug . '-plugin-style', plugins_url( 'public/assets/css/accordion-slider.css', dirname( __FILE__ ) ), array(), self::VERSION );
			...
			wp_register_style( $this->plugin_slug . '-plugin-style', plugins_url( 'public/assets/css/accordion-slider.min.css', dirname( __FILE__ ) ), array(), self::VERSION );
	...
	public function register_scripts() {
		if ( get_option( 'accordion_slider_load_unminified_scripts' ) == true ) {
			wp_register_script( $this->plugin_slug . '-plugin-script', plugins_url( 'public/assets/js/jquery.accordionSlider.js', dirname( __FILE__ ) ), array( 'jquery' ), self::VERSION );
			...
			wp_register_script( $this->plugin_slug . '-plugin-script', plugins_url( 'public/assets/js/jquery.accordionSlider.min.js', dirname( __FILE__ ) ), array( 'jquery' ), self::VERSION );
	...
	public function get_accordion( $id ) {
		...
		return BQW_Accordion_Slider_Validation::validate_accordion_slider_data( $accordion );
	}

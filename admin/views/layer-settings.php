	...
	<ul>
		...
		<li>
			...
			<div class="setting-fields">
				...
				<input class="setting" type="text" name="height" value="<?php echo isset( $layer_settings['height'] ) ? esc_attr( $layer_settings['height'] ) : $layer_default_settings['height']['default_value']; ?>" />

				<label><?php _e( 'Position', 'accordion-slider' ); ?></label>
				<select class="setting" name="position">
					<?php
				...
				<input class="setting" type="text" name="horizontal" value="<?php echo isset( $layer_settings['horizontal'] ) ? esc_attr( $layer_settings['horizontal'] ) : $layer_default_settings['horizontal']['default_value']; ?>" />

				<label><?php _e( 'Vertical', 'accordion-slider' ); ?></label>
				<input class="setting" type="text" name="vertical" value="<?php echo isset( $layer_settings['vertical'] ) ? esc_attr( $layer_settings['vertical'] ) : $layer_default_settings['vertical']['default_value']; ?>" />

				<br/><br/>

				<input class="setting" type="checkbox" name="black_background" <?php echo ( isset( $layer_settings['black_background'] ) && $layer_settings['black_background'] === true ) || ( ! isset( $layer_settings['black_background'] ) &&  $layer_default_settings['black_background']['default_value'] === true ) ? 'checked="checked"' : ''; ?>/>
				<label><?php _e( 'Black Background', 'accordion-slider' ); ?></label>

				<input class="setting" type="checkbox" name="white_background" <?php echo ( isset( $layer_settings['white_background'] ) && $layer_settings['white_background'] === true ) || ( ! isset( $layer_settings['white_background'] ) &&  $layer_default_settings['white_background']['default_value'] === true ) ? 'checked="checked"' : ''; ?>/>
				<label><?php _e( 'White Background', 'accordion-slider' ); ?></label>

				<input class="setting" type="checkbox" name="padding" <?php echo ( isset( $layer_settings['padding'] ) && $layer_settings['padding'] === true ) || ( ! isset( $layer_settings['padding'] ) &&  $layer_default_settings['padding']['default_value'] === true ) ? 'checked="checked"' : ''; ?>/>
				<label><?php _e( 'Padding', 'accordion-slider' ); ?></label>

				<input class="setting" type="checkbox" name="round_corners" <?php echo ( isset( $layer_settings['round_corners'] ) && $layer_settings['round_corners'] === true ) || ( ! isset( $layer_settings['round_corners'] ) && $layer_default_settings['round_corners']['default_value'] === true ) ? 'checked="checked"' : ''; ?>/>
				<label><?php _e( 'Round Corners', 'accordion-slider' ); ?></label>

				<label><?php _e( 'Custom Class', 'accordion-slider' ); ?></label>
				<input class="setting" type="text" name="custom_class" value="<?php echo isset( $layer_settings['custom_class'] ) ? esc_attr( $layer_settings['custom_class'] ) : $layer_default_settings['custom_class']['default_value']; ?>" />
			</div>
		</li>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<select class="setting" name="show_transition">
									<?php
								...
								<input class="setting" type="text" name="show_offset" value="<?php echo isset( $layer_settings['show_offset'] ) ? esc_attr( $layer_settings['show_offset'] ) : $layer_default_settings['show_offset']['default_value']; ?>" />

								<label><?php _e( 'Delay', 'accordion-slider' ); ?></label>
								<input class="setting" type="text" name="show_delay" value="<?php echo isset( $layer_settings['show_delay'] ) ? esc_attr( $layer_settings['show_delay'] ) : $layer_default_settings['show_delay']['default_value']; ?>" />

								<label><?php _e( 'Duration', 'accordion-slider' ); ?></label>
								<input class="setting" type="text" name="show_duration" value="<?php echo isset( $layer_settings['show_duration'] ) ? esc_attr( $layer_settings['show_duration'] ) : $layer_default_settings['show_duration']['default_value']; ?>" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<label><?php _e( 'Transition', 'accordion-slider' ); ?></label>
								<select class="setting" name="hide_transition">
									<?php
								...
								<label><?php _e( 'Offset', 'accordion-slider' ); ?></label>
								<input class="setting" type="text" name="hide_offset" value="<?php echo isset( $layer_settings['hide_offset'] ) ? esc_attr( $layer_settings['hide_offset'] ) : $layer_default_settings['hide_offset']['default_value']; ?>" />

								<label><?php _e( 'Delay', 'accordion-slider' ); ?></label>
								<input class="setting" type="text" name="hide_delay" value="<?php echo isset( $layer_settings['hide_delay'] ) ? esc_attr( $layer_settings['hide_delay'] ) : $layer_default_settings['hide_delay']['default_value']; ?>" />

								<label><?php _e( 'Duration', 'accordion-slider' ); ?></label>
								<input class="setting" type="text" name="hide_duration" value="<?php echo isset( $layer_settings['hide_duration'] ) ? esc_attr( $layer_settings['hide_duration'] ) : $layer_default_settings['hide_duration']['default_value']; ?>" />
							</td>
						</tr>
					</tbody>
				</table>
